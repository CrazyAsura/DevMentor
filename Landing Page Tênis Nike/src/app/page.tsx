      ...
      <article>
        ...
        <article className=" grid  grid-cols-2 mx-10">
          <section className=" bg-[#FFFFFF] p-16 ">
            ...
            <button className=" text-white mt-8 p-2 bg-[#151823] hover:bg-[#FFFFFF] hover:border hover:border-[#151823] hover:border-solid hover:text-black">
              QUERO CONHECER!
            </button>
          </section>
          <section className="  flex justify-center items-center p-14 bg-gradient-to-b from-[#FFEC42] from-21.56%  via-[#E2C151] via-60% to-[#10131D] to-60%">
            <Image
              className="relative -top-[48px] max-md:top-2 max-sm:top-10 transition-transform duration-1000 delay-500 hover:scale-150 hover:-rotate-[-3.6deg]"
              src="/tenis.jpg"
              alt="Tenis da Nike"
              width={488}
              height={280.3}
